<template>
  <div>
    ...
    <el-dialog title="图片预览" :visible.sync="previewVisible" width="50%">
      <img class="previewImage" :src="previewPath" alt="" />
    </el-dialog>
  </div>
</template>
...
export default {
  data() {
    return {
      ...
      addFormRules: {
        ...
        goods_weight: [
          { required: true, message: "请输入商品重量(g)", trigger: "blur" },
        ],
        goods_number: [
  ...
  methods: {
    ...
    //填写必要信息才能切换tab标签
    beforeTabLeave(toName, fromName) {
    ...
    add(){
      ...
      this.$refs.addFormRef.validate(async valid=>{
        ...
        //lodash深拷贝原数据 将新对象的form_cat值改为字符串 
